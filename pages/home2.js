                          ...
                          <div className="btn-slider">
                            <Link href="/classes">
                              <a className="fl-btn st-2">
                                <span className="inner">Keşfet</span>
                              </a>
                            </Link>
                          </div>
                        </div>
            ...
            <div className="col-12">
              <div className="title-heading st-2">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <LeftArrow />
                  <span className="inner-sub st-1">Biz Kimiz</span>
                  <RightArrow />
                </div>
                <h2 className="title clr-pri-2">Garden Anaokulunu Keşfet</h2>
              </div>
            </div>
            <div className="col-12">
                  ...
                  <div className="inner-discovery">
                    ...
                    <Link href="/about">
                      <a className="fl-btn st-10">
                        <span className="inner">Devamını Oku</span>
                      </a>
                    </Link>
                  </div>
                </div>
