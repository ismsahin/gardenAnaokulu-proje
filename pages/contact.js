...
const Contact = () => {
  return (
    <Layout bodyClass={"contact"}>
      <PageBanner pageName={"İletişim"} pageTitle={"Bizimle İletişime Geç"} />
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="title-heading st-2">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <LeftArrow />
                  <span className="inner-sub st-1">
                    Yardıma ihtiyacınız mı var
                  </span>
                  <RightArrow />
                </div>
                <h2 className="title clr-pri-2">
                  Size bu konularda yardım edebiliriz
                </h2>
              </div>
            </div>
            <div className="col-md-4">
              ...
              >
                <div className="image">
                  <img src="assets/images/common/sc-faq1.jpg" alt="Image" />
                </div>
                <div className="content">
                  <h4>Eğitim ve Oyun</h4>
                  <p className="desc">
                    Çocukların öğrenirken keyif alacağı, eğlence dolu
                    aktivitelerimizle ilgili detayları paylaşmaktan mutluluk
                    duyarız.
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4">
              ...
              >
                <div className="image">
                  <img src="assets/images/common/sc-faq2.jpg" alt="Image" />
                </div>
                <div className="content">
                  <h4>Aile Katılımı</h4>
                  <p className="desc">
                    Çocuklarımızın sosyal becerilerini geliştirmek, keyifli
                    vakit geçirmelerini sağlamak amacıyla düzenlediğimiz
                    etkinlikler hakkında detaylı bilgi alabilirsiniz.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              ...
              >
                ...
                <div className="content">
                  <h4>Destek ve Bilgi</h4>
                  <p className="desc">
                    Çocuğunuzun güvende hissedeceği, sevgi ve öğrenme dolu bir
                    ortam sunuyoruz. Merak ettiğiniz her konuda bilgi almak için
          ...
          <div className="row">
            <div className="col-md-5">
              <div className="title-heading">
                <div className="sub-heading clr-pri-3 f-mulish">
                  <span className="inner-sub">Bizimle İletişime Geç</span>
                  <RightArrow />
                </div>
                <h2 className="title clr-pri-2 m-b26">
                  Daha fazla bilgi için iletişime geç
                </h2>
                <p className="f-mulish">Yeşilköy mah.</p>
              </div>
              <div className="wrap-contact">
                <div className="fx adress">
                  ...
                  <div className="content">
                    <p>Adres</p>
                    <h4>Yeşilköy mah. Bakırköy/İstanbul</h4>
                  </div>
                </div>
                <div className="fx Email">
                  ...
                  <div className="content">
                    <p>Email Adresi</p>
                    <h4>destek@gardenanaokulu.com</h4>
                  </div>
                </div>
            ...
            <div className="col-md-7">
              <div
                ...
                data-wow-duration="1200ms"
              >
                <img src="assets/images/common/01-contact.jpeg" alt="" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="tf-section map">
          <div className="flat-map">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d4495.439015453257!2d28.82414587769474!3d40.958903366939175!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1str!2str!4v1738094256003!5m2!1str!2str"
              width={1720}
              height={655}
              style={{
                border: 0,
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-message">
                <h2 className="heading">Mesaj Gönder</h2>
                <form
                  action="/"
                  method="post"
                  id="commentform"
                  ...
                  <div className="fx flex-wrap">
                    ...
                    <div className="wrap-btn">
                      <button type="submit" className="fl-btn st-6">
                        <span className="inner">Mesaj Gönder</span>
                      </button>
                    </div>
                  </div>
                </form>
